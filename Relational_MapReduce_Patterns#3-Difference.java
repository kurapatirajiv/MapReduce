//https://www.hackerrank.com/challenges/relational-mapreduce-patterns-3-difference
import java.util.*;
...
class MapReduce
{
   ...
   private void reducer(int key, HashSet value)
   {
      ...
      //We could just use the get method but since the method has to iterate for other elements
      // list size should be 1 to eliminate intersections
      // We Only filter elements in R
