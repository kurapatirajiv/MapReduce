// https://www.hackerrank.com/challenges/map-reduce-tutorials-1-word-counts
import java.util.*;
...
class MapReduce
{
   ...
   {
      //Adding up all the word counts in the list, each time the word occurs we add 1 to the list 
      int total = 0;
      for (Object Varcount: value){
          total = total + (int)Varcount;
      } 
   ...
   private void mapper(JSONObject record)
   {
      ...
      {
         //Each time the word occurs we add 1 to the list 
