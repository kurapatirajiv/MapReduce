//https://www.hackerrank.com/challenges/map-reduce-tutorials-3-composite-keys
import java.util.*;
...
class MapReduce
{
   ...
   private <T> void reducer(T key, ArrayList value)
   {
      ...
      for (Object temp: value){          
          population = population + (double)temp;
      }  
   ...
   private void mapper(JSONObject record)
   {
      ...
      //Send the State-population as pairs to the intermediate function to group
